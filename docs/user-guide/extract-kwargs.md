...
<!-- test: test_decorators.py::TestExtractKwargsBasic::test_extract_multiple_prefixes -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L27-L48)
...
<!-- test: test_decorators.py::TestExtractKwargsBasic::test_no_extracted_kwargs -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L50-L62)

## Advanced Options

### Custom Extraction Options

<!-- test: test_decorators.py::TestExtractKwargsBasic::test_extract_with_pop_false -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L64-L76)
...
<!-- test: test_decorators.py::TestExtractKwargsBasic::test_extract_with_slice_prefix_false -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L78-L90)

## Reserved Keywords

<!-- test: test_decorators.py::TestExtractKwargsBasic::test_reserved_class_keyword -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L92-L102)

## Merging with Existing kwargs

<!-- test: test_decorators.py::TestExtractKwargsBasic::test_merge_with_existing_kwargs -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L104-L123)

## Advanced Features

### Dynamic Extraction Specs (_dictkwargs)

<!-- test: test_decorators.py::TestExtractKwargsBasic::test_dictkwargs_parameter -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L125-L140)

This is useful when extraction specs come from configuration or are computed at runtime.

### Adapter Hook (_adapter)

<!-- test: test_decorators.py::TestExtractKwargsAdapter::test_adapter_called -->
...
[From test](https://github.com/genropy/smartseeds/blob/main/tests/test_decorators.py#L146-L176)
